...
sudo scutil --set ComputerName "Brian's Macbook"
sudo scutil --set HostName "Brian's Macbook"
sudo scutil --set LocalHostName "brians-macbook"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Brian's Macbook"
